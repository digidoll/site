<?php
 ...
 ?>
	...
	<h1> index
	<span> homepage </span></h1>

<blockquote>
  Cras in leo. In lacinia augue enim, nec porta velit dignissim et. Vestibulum rutrum non arcu elementum condimentum. Ut accumsan a risus sit amet dictum.
</blockquote>
...
<h2> header two. </h2>
  <div id="tools">
    <div id="box"><i class="fas fa-file-code"></i>
...
<div class="deck">
  <div class="card">
    <img src="https://via.placeholder.com/800x300/111111/ededed" id="card">
    <div id="desc">
      <h2>title</h2>
      <p>date
      <br>media
  ...
  <div class="card">
    <img src="https://via.placeholder.com/800x300/f7f7f7/111111" id="card">
    <div id="desc">
      <h2>title</h2>
      <p>date
      <br>media
