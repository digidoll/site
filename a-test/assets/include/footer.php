...
<div id="Out" class="title" style="right: 70%;">
    <ul>
      <li class="title"> outlinks </li>
...
<div id="Out" class="title" style="right: 50%;">
  <ul>
    <li class="title"> credits </li>
    <li><a href="#" target="_self">link 001</a></li>
    <li><a href="#" target="_self">link 002</a></li>
  </ul>
</div>

<div id="Out" class="title" style="right: 30%;">
  <ul>
...
<div id="Out" class="title" style="right: 10%;">
  <ul>
    ...
    <div id="music">
      <div class="youtubebox">
    	...
    	<button type="button" class="playerbutton" id="playbutton" onclick="codes_9Id5q.playVideo();toggleButtonPlayer_9Id5q(this)">
    		<img src="/site/a-test/assets/img/play.png">
    	</button>
    	<button type="button" class="playerbutton" id="pausebutton" onclick="codes_9Id5q.pauseVideo();toggleButtonPlayer_9Id5q(this)" style="display:none">
    		<img src="/site/a-test/assets/img/pause.png">
    	</button>
    	<div class="preload_box"><img src="/site/a-test/assets/img/play.png"><img src="/site/a-test/assets/img/pause.png"></div>
</div>
  </ul>
</div>
