...
<meta content="width=device-width, initial-scale=1" name="viewport" />
	...
	<script src="/site/bba/assets/js/ism-2.2.min.js"></script>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js"></script>
	<script type='text/javascript' src='/site/bba/assets/js/jquery.ba-hashchange.min.js'></script>
	<script type='text/javascript' src='/site/bba/assets/js/dynamicpage.js'></script>
	<script type='text/javascript' src='/site/bba/assets/js/music.js'></script>
...
<header>
	...
	<div id="overlay"></div>
		<div id="logo">
			<h5> Berks Barber Guild
			<span> Est. 1990 <span> </h5>
		</div>
</header>
